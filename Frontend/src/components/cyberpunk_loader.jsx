        ...
        <AnimatePresence>
            {!isComplete && (
                <motion.div 
                    ...
                    className="fixed inset-0 z-50 bg-gradient-to-br from-black via-purple-900/20 to-black overflow-hidden"
                >
                    ...
                    <div className="relative z-10 h-full flex flex-col items-center justify-center px-8">
                        ...
                        >
                            <motion.h1 
                                className="text-6xl lg:text-8xl font-bold mb-4 font-mono"
                                style={{
